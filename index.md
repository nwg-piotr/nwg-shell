...
**Starting from the 0.5.x version, nwg-shell also offers support for the Hyprland Wayland compositor. All the component apps are Hyprland-ready, and the shell comes with 4 hyprland-* presets. Hyprland support is an addition to the shell, not a standalone feature.**
